...
Usage:
  echo "PROMPT" | tools/ghidra/llm_local.py
  tools/ghidra/llm_local.py -p "PROMPT" [--system "..."] [--model X] [--max 2048] [--temp 0.2]
  tools/ghidra/llm_local.py --ping            # health check / list models
"""
