...
#
# Usage:
#   tools/overlay2c.sh <hex_addr> <len_bytes> [binfile] [base_addr]
...
#
# Example: tools/overlay2c.sh 0x80082190 0x1b0
set -euo pipefail
...
python3 "$HERE/tools/objdump2m2c.py" "$addr" < "$tmp/dump.txt" > "$tmp/fn.s"
